...
parent.document.location="home.php";
  ...
  $message = "AdminID or Password invalid.";
...
<center>   
   <h1>Login</h1>
    ...
    <hr>
  <center><img src="admin.png" alt="Avatar" class="avatar" height="10%" width="10%">
   </center>
    <label for="id"><b>Admin ID</b></label>
    <input type="text" placeholder="Enter Admin ID" name="user" id="email" required>
