...
echo" <tr>
    ...
    <td>$contact</td>
	<td>$address</td>
	<td><form method=\"POST\" action=\"supplier.php\"><input type=\"submit\" name=\"$uid\" value=\"Delete\"onClick=\"document.location.reload(true)\">
	</td>
	</tr>
    ";
...
{
	//echo '$id';
	$query=mysqli_query($connect,"DELETE FROM `supplier_details` WHERE `id`='$uid'") or die(mysqli_error($connect));
	$query=mysqli_query($connect,"DELETE FROM `added_items` WHERE `supplier_id`='$uid'") or die(mysqli_error($connect));
